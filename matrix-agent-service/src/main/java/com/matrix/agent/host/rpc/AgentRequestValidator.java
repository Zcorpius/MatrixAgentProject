...
public final class AgentRequestValidator {
    ...
    public static void validateSubmit(AgentRequest request) {
    ...
    public static void validateSteer(SteerRequest request) {
        if (request == null || request.schemaVersion != ParcelSchema.CURRENT) {
    ...
    public static void validateConfirmation(ConfirmationDecision decision) {
