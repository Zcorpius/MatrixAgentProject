...
public final class ModelServiceStub extends IModelService.Stub {
    ...
    public interface CallerResolver { CallerContext caller(); }

    public ModelServiceStub(@NonNull ModelGatewayRepository models,
    ...
    private void activateSelectedModel(ModelConfig selected) throws Exception {
        com.matrix.agent.contract.ModelGateway gateway = models.createModelGateway(selected);
        com.matrix.agent.intent.IntentClassifier classifier =
