...
final class PersistentTaskManager {
    ...
    PersistentTaskManager(@NonNull PersistentTaskStore store, @NonNull AgentRuntimeRepository runtime,
    ...
    int recoverAfterProcessDeath() {
        return store.markInterruptedExecutionsUnknown();
    }

    AgentTaskHandle submit(@NonNull CallerContext caller, @NonNull AgentRequest request,
    ...
    @Nullable AgentTaskSnapshot snapshot(@NonNull CallerContext caller, @NonNull String taskId) {
        return store.snapshot(taskId, caller.uid);
    }

    void subscribe(@NonNull CallerContext caller, @NonNull String taskId, long afterSequence,
    ...
    void unsubscribe(@NonNull String taskId, @Nullable IAgentTaskCallback callback) {
        unregister(taskId, callback);
    }

    AgentOperationResult cancel(@NonNull CallerContext caller, @NonNull String taskId,
    ...
    AgentOperationResult steer(@NonNull CallerContext caller, @NonNull String taskId,
    ...
    AgentOperationResult resume(@NonNull CallerContext caller, @NonNull String taskId,
            @NonNull String operationId) {
        requireOperationId(operationId);
    ...
    AgentOperationResult reservedUnsupported(@NonNull CallerContext caller, @NonNull String taskId,
